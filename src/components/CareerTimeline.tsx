...
const events = [
  ...
  { year: '2023', title: 'BCA · Jain University',    body: 'Enrolled in Bachelor of Computer Applications. Learned programming, data structures, and web development — bridging design and engineering.',                                                   type: 'edu'        },
  ...
  { year: '2025', title: 'NeuroTwin',                body: 'Designed NeuroTwin — an AI-powered cognitive twin platform. Full product design cycle from research to high-fidelity UI and design system.',                                                    type: 'project', link: 'https://www.behance.net/gallery/251900711/NeuroTwin-Product-Design-Case-Study' },
  { year: '2025', title: 'SkillBridge — Shipped',   body: 'Designed and developed SkillBridge — a peer-to-peer learning platform. First project where I owned both design and frontend implementation end-to-end.',                                       type: 'project', link: 'https://skill-bridge-shin7806s-projects.vercel.app/' },
